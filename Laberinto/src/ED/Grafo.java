 ...
 */
public class Grafo {
	public static final int MAXVERT = 1000;
	...
	public int[][] arcos = new int[MAXVERT][MAXVERT];
	...
	public boolean nuevoArco(int origen, int destino, int valor) {
		...
		if ((origen >= 0) && (origen < numNodos) && (destino >= 0)
				&& (destino < numNodos)) {
	...
	public static void main(String[] args) {
		...
		int[][] arcos = {
				{ 0, 97, Grafo.INFINITO, Grafo.INFINITO, 119, Grafo.INFINITO,
						Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO },
				{ 97, 0, 10, Grafo.INFINITO, Grafo.INFINITO, 57,
						Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO },
				{ Grafo.INFINITO, 10, 0, 17, Grafo.INFINITO, Grafo.INFINITO,
						67, Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO },
				{ Grafo.INFINITO, Grafo.INFINITO, 17, 0, Grafo.INFINITO,
						Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO, 122 },
				{ 119, Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO, 0,
						Grafo.INFINITO, Grafo.INFINITO, 37, Grafo.INFINITO,
						Grafo.INFINITO },
				{ Grafo.INFINITO, 57, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO, 0, 63, Grafo.INFINITO, 50,
						Grafo.INFINITO },
				{ Grafo.INFINITO, Grafo.INFINITO, 67, Grafo.INFINITO,
						Grafo.INFINITO, 63, 0, Grafo.INFINITO, 61,
						Grafo.INFINITO },
				{ Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO, 37, Grafo.INFINITO, Grafo.INFINITO, 0,
						72, Grafo.INFINITO },
				{ Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
						Grafo.INFINITO, Grafo.INFINITO, 50, 61, 72, 0, 153 },
				{ Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO, 122,
						Grafo.INFINITO, Grafo.INFINITO, Grafo.INFINITO,
		...
		for (int i = 0; i < 10; i++)
			for (int j = 0; j < 10; j++)
				if (!g.nuevoArco(nodos[i], nodos[j], arcos[i][j]))
					System.out.println("Error en la insercion del arco(" + i
							+ "," + j + ")");
		...
		// ------------------------------------------------------------------------------
		// Camino minimo entre 0 y 9
		int origen = nodos[0];
		int destino = nodos[9];
		while (origen != destino) {
			System.out.println("Siguiente nodo a avisitar: ");
